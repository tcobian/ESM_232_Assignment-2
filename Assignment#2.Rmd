...
# Add in some error checking into the function
  ...
  if (P < 0) return("Input for precipitation must be a value larger than 0")
  
  # Make sure that the maximum tempertaure will be larger than the minimum temperature
  if (tmin_c > tmax_c) return("Cannot contain inputs where is minimum termperature is larger than the maximum termperature")
