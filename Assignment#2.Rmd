...
```{r}
almond_yield <- function(years , months, tmin_c, tmax_c, percip, a=0.015, b=- 0.0046, c=-0.07, d=0.0043, e=0.28 ){

  # Yield Equation
  Y <-  a*tmin_c[2] + b*tmin_c[2]^2 +c*P[1] + d*P[1]^2 + e
...
almond_yield <- function( clim_data = clim_month,
                       a=0.015,
                       b=-0.0046,
                       c=-0.07,
                       d=0.0043,
  ...
  yield_df <- data.frame(year = year, YA = NA)
