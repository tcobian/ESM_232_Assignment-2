...
almond_yield <- function( clim_data = clim,
 ...
 #clim_data = ifelse(all(has_name(clim_data, c("month", "year", "P", "Tm", "Tn"))) != TRUE, return ("Climate data input must contain the following columns: year, month, precip, tmin_c and tmax_c"), clim_data)
